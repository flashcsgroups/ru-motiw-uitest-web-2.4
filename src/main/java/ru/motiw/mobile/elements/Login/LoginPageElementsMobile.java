...
public class LoginPageElementsMobile {
    ...
    @FindBy(xpath = "//a[@class=\"m_link\"]")
    private SelenideElement linkToMobile;
    ...
    /**
     * Ссылка в форме авторизации полной версии для перехода в мобильную версию
     */
    public SelenideElement getLinkToMobile() {
        return linkToMobile;
    }
